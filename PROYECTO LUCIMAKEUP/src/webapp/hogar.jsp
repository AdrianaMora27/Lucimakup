    ...
    <main class="contenedor">
        ...
        <div class="grid-productos">
            ...
            <div class="tarjeta-producto" data-id="301">
                <a href="producto.html?id=301" class="tarjeta-producto__imagen">
                    <img src="img/cojinesEstampados.jpeg" alt="Cojines estampados">
                </a>
                <div class="tarjeta-producto__info">
                    <h3 class="tarjeta-producto__nombre">Cojines estampados</h3>
                    <a href="producto.html?id=301" class="tarjeta-producto__boton">Ver producto</a>
                </div>
            </div>

            <!-- PRODUCTO 302 -->
            <div class="tarjeta-producto" data-id="302">
                <a href="producto.html?id=302" class="tarjeta-producto__imagen">
                    <img src="img/espejoconDiseño.jpeg" alt="Espejo con diseño">
                </a>
                <div class="tarjeta-producto__info">
                    <h3 class="tarjeta-producto__nombre">Espejo con diseño</h3>
                    <a href="producto.html?id=302" class="tarjeta-producto__boton">Ver producto</a>
                </div>
            </div>

            <!-- PRODUCTO 303 -->
            <div class="tarjeta-producto" data-id="303">
                <a href="producto.html?id=303" class="tarjeta-producto__imagen">
                    <img src="img/soportePC.jpeg" alt="Soporte para computador portátil">
                </a>
                <div class="tarjeta-producto__info">
                    <h3 class="tarjeta-producto__nombre">Soporte para computador portátil</h3>
                    <a href="producto.html?id=303" class="tarjeta-producto__boton">Ver producto</a>
                </div>
            </div>
        ...
        <div class="grid-productos">
            ...
            <div class="tarjeta-producto" data-id="304">
                <a href="producto.html?id=304" class="tarjeta-producto__imagen">
                    <img src="img/difusorAroma.jpeg" alt="Difusor de aroma electrónico">
                </a>
                <div class="tarjeta-producto__info">
                    <h3 class="tarjeta-producto__nombre">Difusor de aroma electrónico</h3>
                    <a href="producto.html?id=304" class="tarjeta-producto__boton">Ver producto</a>
                </div>
            </div>

            <!-- PRODUCTO 305 -->
            <div class="tarjeta-producto" data-id="305">
                <a href="producto.html?id=305" class="tarjeta-producto__imagen">
                    <img src="img/velaAromatica.jpeg" alt="Vela con aroma">
                </a>
                <div class="tarjeta-producto__info">
                    <h3 class="tarjeta-producto__nombre">Vela con aroma</h3>
                    <a href="producto.html?id=305" class="tarjeta-producto__boton">Ver producto</a>
                </div>
            </div>

            <!-- PRODUCTO 306 -->
            <div class="tarjeta-producto" data-id="306">
                <a href="producto.html?id=306" class="tarjeta-producto__imagen">
                    <img src="img/aceiteEscencial.jpeg" alt="Aceite esencial Lavanda">
                </a>
                <div class="tarjeta-producto__info">
                    <h3 class="tarjeta-producto__nombre">Aceite esencial Lavanda</h3>
                    <a href="producto.html?id=306" class="tarjeta-producto__boton">Ver producto</a>
                </div>
            </div>
